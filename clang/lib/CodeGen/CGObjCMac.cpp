...
void CGObjCCommonMac::BuildRCBlockVarRecordLayout(const RecordType *RT,
  ...
  const llvm::StructLayout *RecLayout =
    CGM.getDataLayout().getStructLayoutBeforeDeluge(cast<llvm::StructType>(Ty));
...
void CGObjCCommonMac::fillRunSkipBlockVars(CodeGenModule &CGM,
  ...
  CGM.getDataLayout().getStructLayoutBeforeDeluge(blockInfo.StructureType);
...
CGObjCMac::EmitProtocolExtension(const ObjCProtocolDecl *PD,
  ...
  uint64_t size =
    CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(ObjCTypes.ProtocolExtensionTy);
...
llvm::Constant *CGObjCCommonMac::EmitPropertyList(Twine Name,
  ...
  unsigned propertySize =
    CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(ObjCTypes.PropertyTy);
...
void CGObjCMac::GenerateCategory(const ObjCCategoryImplDecl *OCD) {
  unsigned Size = CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(ObjCTypes.CategoryTy);
...
llvm::Constant *CGObjCMac::EmitMetaClass(const ObjCImplementationDecl *ID,
  ...
  unsigned Size = CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(ObjCTypes.ClassTy);
...
CGObjCMac::EmitClassExtension(const ObjCImplementationDecl *ID,
  ...
  uint64_t size =
    CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(ObjCTypes.ClassExtensionTy);
...
void CGObjCMac::EmitObjCWeakAssign(CodeGen::CodeGenFunction &CGF,
  ...
  if (!isa<llvm::PointerType>(SrcTy)) {
    unsigned Size = CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(SrcTy);
...
void CGObjCMac::EmitModuleInfo() {
  uint64_t Size = CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(ObjCTypes.ModuleTy);
...
void CGObjCNonFragileABIMac::GenerateClass(const ObjCImplementationDecl *ID) {
  ...
  uint32_t InstanceStart =
    CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(ObjCTypes.ClassnfABITy);
...
void CGObjCNonFragileABIMac::GenerateCategory(const ObjCCategoryImplDecl *OCD) {
  ...
  unsigned Size =
      CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(ObjCTypes.CategorynfABITy);
  values.addInt(ObjCTypes.IntTy, Size);
...
CGObjCNonFragileABIMac::emitMethodList(Twine name, MethodListType kind,
  ...
  unsigned Size = CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(ObjCTypes.MethodTy);
  values.addInt(ObjCTypes.IntTy, Size);
  // method_count
  values.addInt(ObjCTypes.IntTy, methods.size());
  auto methodArray = values.beginArray(ObjCTypes.MethodTy);
...
llvm::Constant *CGObjCNonFragileABIMac::EmitIvarList(
  ...
  ivarList.addInt(ObjCTypes.IntTy,
                  CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(ObjCTypes.IvarnfABITy));
...
llvm::Constant *CGObjCNonFragileABIMac::GetOrEmitProtocol(
  ...
  uint32_t Size =
    CGM.getDataLayout().getTypeAllocSizeBeforeDeluge(ObjCTypes.ProtocolnfABITy);
  values.addInt(ObjCTypes.IntTy, Size);
