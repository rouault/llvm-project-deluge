...
public:
  ...
  Address CreateStructGEP(Address Addr, unsigned Index,
    ...
    const llvm::StructLayout *Layout = DL.getStructLayoutBeforeFilC(ElTy);
  ...
  Address CreateConstArrayGEP(Address Addr, uint64_t Index,
    ...
    const llvm::DataLayout &DL = BB->getParent()->getParent()->getDataLayout();
    CharUnits EltSize =
        CharUnits::fromQuantity(DL.getTypeAllocSizeBeforeFilC(ElTy->getElementType()));
  ...
  Address CreateConstInBoundsGEP(Address Addr, uint64_t Index,
    ...
    const llvm::DataLayout &DL = BB->getParent()->getParent()->getDataLayout();
    CharUnits EltSize = CharUnits::fromQuantity(DL.getTypeAllocSizeBeforeFilC(ElTy));
  ...
  Address CreateConstGEP(Address Addr, uint64_t Index,
    ...
    const llvm::DataLayout &DL = BB->getParent()->getParent()->getDataLayout();
    CharUnits EltSize =
        CharUnits::fromQuantity(DL.getTypeAllocSizeBeforeFilC(Addr.getElementType()));
