#ifndef FILC_HEAP_CONFIG_H
#define FILC_HEAP_CONFIG_H
...
PAS_API void filc_heap_config_activate(void);

#define FILC_HEAP_CONFIG PAS_BASIC_HEAP_CONFIG( \
    filc, \
    .activate = filc_heap_config_activate, \
    ...
    .get_type_runtime_config = filc_type_as_heap_type_get_runtime_config, \
...
PAS_API extern const pas_heap_config filc_heap_config;

PAS_BASIC_HEAP_CONFIG_DECLARATIONS(filc, FILC);

#endif /* PAS_ENABLE_FILC */

#endif /* FILC_HEAP_CONFIG_H */
